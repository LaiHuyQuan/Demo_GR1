...
//                 newLi.classList.add('dropdown-item', 'notification-item');
        
//                 const newLink = document.createElement('a');
//                 newLink.classList.add('d-flex', 'align-items-center');
//                 newLink.href = '#';
        
//                 const newText = document.createElement('div');
//                 newText.classList.add('notification-text', 'ms-4');
        
//                 const newTitle = document.createElement('p');
//                 newTitle.classList.add('notification-title', 'font-bold');
//                 newTitle.textContent = 'New Element'; // Change the text as needed
